...
{
    public partial class kayitlifirmadiger : Form
    {
        public kayitlifirmadiger()
        {
            InitializeComponent();
        }

        private void kayitlifirmadiger_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'onmuhasebesmartdataDataSet27.firma' table. You can move, or remove it, as needed.
            this.firmaTableAdapter1.Fill(this.onmuhasebesmartdataDataSet27.firma);
