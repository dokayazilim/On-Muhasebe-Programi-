...
namespace onmuhasebe
{
    public partial class satisfatura : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'onmuhasebesmartdataDataSet9.satisfaturalari' table. You can move, or remove it, as needed.
            this.satisfaturalariTableAdapter1.Fill(this.onmuhasebesmartdataDataSet9.satisfaturalari);
        ...
        private void button4_Click(object sender, EventArgs e)
        {
                ...
                try
                {
                    ...
                    baglan.Open();
                    OleDbCommand komut = new OleDbCommand("insert into satisfaturalari(tarih,belgeno,islemturu,cariadi,bruttutar,kdvtutari,toplamtutar) values ('" + tarih.Text + "','" + belgeno.Text + "','" + islemturu.Text + "','" + cariadi.Text + "','" + tutar.Text + "','" + toplamkdv + "','" + toplamtutar + "')");
                ...
                try
                {
                    ...
                    baglanti.Open();
                    OleDbCommand komut2 = new OleDbCommand("insert into carirapor(tarih,vade,evrakno,odemesekli,aciklama,alacak) values ('" + tarih.Text + "','" + "Vade Yok" + "','" + belgeno.Text + "','" + "Peşin" + "','" + "Açıklama Yok" + "','" + tutar.Text + "')");
                    komut2.Connection = baglanti;
                    komut2.ExecuteNonQuery();
                    baglanti.Close();
                    tarih.Clear();
                    belgeno.Clear();
                    islemturu.Text = "Satış Faturası";
                    cariadi.Text = "Demo";
                    tutar.Clear();
        ...
        public void listele()
        {
            ...
            OleDbDataAdapter adpt = new OleDbDataAdapter("Select*from satisfaturalari", con);
            adpt.Fill(dt);
        ...
        private void cariadi_TextChanged(object sender, EventArgs e)
        {
        ...
        private void silToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (sonuc == DialogResult.Yes)
            {
                ...
                try
                {
                    OleDbConnection baglan = new OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0; Data Source=|DataDirectory|\\onmuhasebesmartdata.accdb; Persist Security Info=False;");
                    baglan.Open();
                    OleDbCommand komut = new OleDbCommand("delete from satisfaturalari where tarih='" + tarih.Text + "'");
                    komut.Connection = baglan;
                    komut.ExecuteNonQuery();
                    baglan.Close();
                    listele();
