...
{
    public partial class satisirsaliye : Form
    {
        public satisirsaliye()
        {
            InitializeComponent();
        }

        private void satisirsaliye_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'onmuhasebesmartdataDataSet10.satisirsaliyesi' table. You can move, or remove it, as needed.
            this.satisirsaliyesiTableAdapter1.Fill(this.onmuhasebesmartdataDataSet10.satisirsaliyesi);
        ...
        private void button5_Click(object sender, EventArgs e)
        {
                ...
                try
                {
                    ...
                    baglan.Open();
                    OleDbCommand komut = new OleDbCommand("insert into satisirsaliyesi(irsaliyetarihi,irsaliyeno,carihesap,tutar,kdv,geneltoplam,faturano,durumu) values ('" + irsaliyetarihi.Text + "','" + irsaliyeno.Text + "','" + carihesap.Text + "','" + tutar.Text + "','" + kdv.Text + "','" + "fatura" + "','" + faturano.Text + "','" + kdv.Text + "')");
                ...
                try
                {
                    ...
                    baglanti.Open();
                    OleDbCommand komut2 = new OleDbCommand("insert into carirapor(tarih,vade,evrakno,odemesekli,aciklama,alacak) values ('" + irsaliyetarihi.Text + "','" + "Vade Yok" + "','" + faturano.Text + "','" + "Peşin" + "','" + durumu.Text + "','" + tutar.Text + "')");
        ...
        public void listele()
        {
            ...
            OleDbDataAdapter adpt = new OleDbDataAdapter("Select*from satisirsaliyesi", con);
            adpt.Fill(dt);
        ...
        private void silToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (sonuc == DialogResult.Yes)
            {
                ...
                try
                {
                    ...
                    baglan.Open();
                    OleDbCommand komut = new OleDbCommand("delete from satisirsaliyesi where irsaliyetarihi='" + irsaliyetarihi.Text + "'");
                    komut.Connection = baglan;
                    komut.ExecuteNonQuery();
                    baglan.Close();
                    listele();
