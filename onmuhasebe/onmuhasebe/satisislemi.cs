...
{
    public partial class satisislemi : Form
    {
        public satisislemi()
        {
            InitializeComponent();
        ...
        {
            // TODO: This line of code loads data into the 'onmuhasebesmartdataDataSet13.satisislemipesin' table. You can move, or remove it, as needed.
            this.satisislemipesinTableAdapter1.Fill(this.onmuhasebesmartdataDataSet13.satisislemipesin);
            // TODO: This line of code loads data into the 'onmuhasebesmartdataDataSet12.satisislemitaksit' table. You can move, or remove it, as needed.
            this.satisislemitaksitTableAdapter1.Fill(this.onmuhasebesmartdataDataSet12.satisislemitaksit);
            // TODO: This line of code loads data into the 'onmuhasebesmartdataDataSet11.satisislemiveresiye' table. You can move, or remove it, as needed.
            this.satisislemiveresiyeTableAdapter1.Fill(this.onmuhasebesmartdataDataSet11.satisislemiveresiye);
        ...
        public void listele()
        {
            ...
            OleDbDataAdapter adpt = new OleDbDataAdapter("Select*from satisislemiveresiye", con);
            adpt.Fill(dt);
        ...
        public void listele3()
        {
            ...
            OleDbDataAdapter adpt = new OleDbDataAdapter("Select*from satisislemitaksit", con);
            adpt.Fill(dt);
        ...
        public void listele2()
        {
            ...
            OleDbDataAdapter adpt = new OleDbDataAdapter("Select*from satisislemipesin", con);
            adpt.Fill(dt);
        ...
        private void button13_Click(object sender, EventArgs e)
        {
            ...
            a.label2.Text = "satisislemiveresiye";
            a.Show();
        }
        ...
        {
            stokalis a = new stokalis();
            a.label2.Text = "satisislemitaksit";
            a.Show();
        }
        ...
        {
            stokalis a = new stokalis();
            a.label2.Text = "satisislemipesin";
            a.Show();
        }
        ...
        private void button9_Click(object sender, EventArgs e)
        {
            ...
            if (sonuc == DialogResult.Yes)
            {
                ...
                try
                {
                    OleDbConnection baglan = new OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0; Data Source=|DataDirectory|\\onmuhasebesmartdata.accdb; Persist Security Info=False;");
                    baglan.Open();
                    OleDbCommand komut = new OleDbCommand("delete from satisislemi where belgeno='" + belgenopesin.Text + "'");
                    komut.Connection = baglan;
                    komut.ExecuteNonQuery();
                    baglan.Close();
                    listele();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            if (sonuc == DialogResult.Yes)
            {
                ...
                try
                {
                    OleDbConnection baglan = new OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0; Data Source=|DataDirectory|\\onmuhasebesmartdata.accdb; Persist Security Info=False;");
                    baglan.Open();
                    OleDbCommand komut = new OleDbCommand("delete from satisislemi where belgeno='" + belgeno.Text + "'");
                    komut.Connection = baglan;
                    komut.ExecuteNonQuery();
                    baglan.Close();
                    listele();
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            if (sonuc == DialogResult.Yes)
            {
                ...
                try
                {
                    OleDbConnection baglan = new OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0; Data Source=|DataDirectory|\\onmuhasebesmartdata.accdb; Persist Security Info=False;");
                    baglan.Open();
                    OleDbCommand komut = new OleDbCommand("delete from satisislemi where belgeno='" + belgenotaksit.Text + "'");
                    komut.Connection = baglan;
                    komut.ExecuteNonQuery();
                    baglan.Close();
                    listele();
