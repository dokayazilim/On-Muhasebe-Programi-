...
{
    public partial class verilencekler : Form
    {
        public verilencekler()
        {
            InitializeComponent();
        }

        private void verilencekler_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'onmuhasebesmartdataDataSet16.verilencekler' table. You can move, or remove it, as needed.
            this.verilenceklerTableAdapter1.Fill(this.onmuhasebesmartdataDataSet16.verilencekler);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        baglan.Open();
                        OleDbCommand komut = new OleDbCommand("insert into verilencekler(evrakno,belgeno,islemtarihi,vade,tutar,banka,sube,hesapno,evrakdurumu,evraktipi,aciklama) values ('" + evrakno.Text + "','" + belgeno.Text + "','" + islemtarihi.Text + "','" + vade.Text + "','" + tutar.Text + "','" + banka.Text + "','" + sube.Text + "','" + hesapno.Text + "','" + evrakdurumu.Text + "','" + evraktipi.Text + "','" + aciklama.Text + "')");
                    ...
                    try
                    {
                        ...
                        baglanti.Open();
                        OleDbCommand komut2 = new OleDbCommand("insert into carirapor(tarih,vade,evrakno,odemesekli,aciklama,alacak) values ('" + islemtarihi.Text + "','" + vade.Text + "','" + evrakno.Text + "','" + "Peşin" + "','" + aciklama.Text + "','" + tutar.Text + "')");
        ...
        public void listele()
        {
            ...
            OleDbDataAdapter adpt = new OleDbDataAdapter("Select*from verilencekler", con);
            adpt.Fill(dt);
        ...
        private void silToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (sonuc == DialogResult.Yes)
            {
                ...
                try
                {
                    OleDbConnection baglan = new OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0; Data Source=|DataDirectory|\\onmuhasebesmartdata.accdb; Persist Security Info=False;");
                    baglan.Open();
                    OleDbCommand komut = new OleDbCommand("delete from verilencekler where belgeno='" + belgeno.Text + "'");
                    komut.Connection = baglan;
                    komut.ExecuteNonQuery();
                    baglan.Close();
                    listele();
